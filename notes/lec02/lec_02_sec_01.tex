...
\dfn{Point Operation}{A transformation $T$ is a point-wise mapping function, given as $$ T : I_{ij} \rightarrow J_{ij} $$ applied to each pixel individually, $$J(x,y) = T[I(x, y)]$$ xwhere $I(x, y)$ is the input.}
